      ...
      <div className="flex grow flex-col items-center justify-center gap-2 pb-24">
        ...
        >
          <input
            ...
            type="password"
            required
            className="rounded-full bg-french-100 p-2 px-4 text-french-900 placeholder-french-800 focus:outline-none focus:ring-2 focus:ring-french-200"
            placeholder="Type in your password..."
          />
          <hr className="my-2 opacity-20" />
          <button
            type="submit"
            className="pointer-events-all pointer-events-auto cursor-pointer rounded-full bg-french-300 p-2 px-4 text-french-900 transition-all duration-300 ease-in-out hover:bg-french-400 focus:outline-none focus:ring-2 focus:ring-french-200"
          >
            Sign in
          </button>
        </form>
