  ...
  if (imgUrl != null) {
    if (error) {
      return (
        <div
          className={
            "flex h-full w-full flex-col items-center justify-center gap-2 border-0 p-16 text-4xl outline-none " +
            props.className
          }
        >
      ...
      return (
        <img
          ...
          alt={props.alt}
          className={
            "flex items-center justify-center border-0 text-4xl outline-none " +
            props.className
          }
