...
export const ReferenceEntry = (props: IReferenceEntry) => {
  ...
  return (
    ...
    >
      <button
        className={[
          "w-full p-2 px-3 text-left font-bold transition-[color,font-size] duration-200 hover:bg-neutral-400/30 focus:outline-none",
